...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-red-700 text-white">
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-6 right-6 z-50 w-12 h-12 bg-white text-red-700 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 ${
